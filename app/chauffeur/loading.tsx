  ...
  return (
    ...
    >
      ...
      <div className="rounded-[18px] bg-surface p-[18px]">
        <div className="h-[13px] w-[90px] rounded-[5px] bg-skeleton" />
        <div className="my-2.5 h-10 w-[170px] rounded-lg bg-line" />
        <div className="h-7 w-[120px] rounded-full bg-skeleton" />
      </div>
      <div className="rounded-[18px] bg-surface p-3.5">
        <div className="grid grid-cols-7 gap-1.5">
          {Array.from({ length: 35 }, (_, i) => (
            <div key={i} className="aspect-square rounded-lg bg-skeleton" />
          ))}
        </div>
      </div>
